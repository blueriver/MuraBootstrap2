...
<cfsavecontent variable="strField">
	...
	<cfloop from="1" to="#ArrayLen(dataset.datarecordorder)#" index="iiy">
		...
		<label class="radio" for="#record.datarecordid#"><input name="#field.name#" id="#record.datarecordid#" type="radio"<cfif record.isselected eq 1> CHECKED</cfif> value="#record.value#">#record.label#</label>
	</cfloop>
	</div>
	</cfoutput>
</cfsavecontent>
