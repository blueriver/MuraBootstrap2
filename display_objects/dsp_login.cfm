...
<div id="svLoginContainer" class="row">
	<section class="span6">
	...
	<form class="form-horizontal" name="frmLogin" method="post" action="?nocache=1" onsubmit="return validate(this);" novalidate="novalidate" >
	<legend>#$.rbKey('user.pleaselogin')#</legend>
		<fieldset>
				<div class="req control-group">
					<label class="control-label" for="txtUsername">#$.rbKey('user.username')#<ins> (#htmlEditFormat($.rbKey('user.required'))#)</ins></label>
					<div class="controls"><input type="text" id="txtUsername" class="text" name="username" required="true" message="#htmlEditFormat($.rbKey('user.usernamerequired'))#" />
					</div>
				</div>
				<div class="req control-group">
					<label class="control-label" for="txtPassword">#$.rbKey('user.password')#<ins> (#htmlEditFormat($.rbKey('user.required'))#)</ins></label>
					<div class="controls"><input type="password" id="txtPassword" class="text" name="password" required="true" message="#htmlEditFormat($.rbKey('user.passwordrequired'))#" />
					</div>
				</div>
				<div class="control-group">
					<div class="controls">
						<label for="cbRememberMe" class="checkbox"><input type="checkbox" class="checkbox" id="cbRememberMe" class="checkbox first" name="rememberMe" value="1" />
	...
	<form name="form2" class="form-horizontal" method="post" action="?nocache=1" onsubmit="return validate(this);" novalidate="novalidate">
		<fieldset>
			<legend>#$.rbKey('user.forgetusernameorpassword')#</legend>
			<p class="help-block">#$.rbKey('user.forgotloginmessage')#</p>
			<div class="control-group">
					<label for="txtEmail" class="control-label">#$.rbKey('user.email')#</label>
					<div class="controls">
