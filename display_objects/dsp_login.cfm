...
<div id="svLoginContainer">
	...
	<cfif not variables.$.event('isBlocked')>
		<form id="login" class="form-horizontal <cfif this.generalWrapperClass neq "">#this.formWrapperClass#</cfif>" name="frmLogin" method="post" action="?nocache=1" onsubmit="return validate(this);" novalidate="novalidate" >
		...
		<form name="form2" class="form-horizontal <cfif this.generalWrapperClass neq "">#this.formWrapperClass#</cfif>" method="post" action="?nocache=1" id="sendLogin" onsubmit="return validate(this);" novalidate="novalidate">
