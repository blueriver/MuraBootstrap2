...
--->
	...
	<cfswitch expression="#$.siteConfig('mbt-bootswatch')#">
		...
		<cfcase value="None">
			...
			@navbarInverseText:               		#$.siteConfig('mbt-navbar-navbarInverseText')#;
			@navbarInverseLinkColor:          		#$.siteConfig('mbt-navbar-navbarInverseLinkColor')#;
			...
			@navbarInverseSearchBackground:   		#$.siteConfig('mbt-navbar-navbarInverseSearchBackground')#;
